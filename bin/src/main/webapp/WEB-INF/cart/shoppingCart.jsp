...
<body>
		...
		<tbody>
			<c:forEach var="carts" items="${carts}">
				<tr>
					...
					<td><a onclick="return confirm('確定刪除嗎?')" href="shoppingCart/${carts.productId}" class="link-dark"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" 	stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-trash"><polyline points="3 6 5 6 21 6"></polyline><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"></path></svg></a></td>
				</tr>
			</c:forEach>
		</tbody>
	</table>
	...
	<table class="goToPay">
		...
		<tbody>
			...
			<tr>
				<td colspan="2">總金額：${totalAmount}&nbsp;<button type="button" class="btn btn-warning">去買她媽的單</button></td>
			</tr>
		</tbody>
	</table>
