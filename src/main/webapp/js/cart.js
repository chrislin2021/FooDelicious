		...
		success: function(carts) {
			...
			if (carts != null) {
				...
				for (let cart of carts) {
					...
					str += '<td><input type="hidden" value=' + cart.quantity + '><button type="button" class="btn btn-secondary btn-sm" onclick="changeMinusNum(' + cart.productId + ',' + cart.quantity + ')" id="minus" ><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-minus"><line x1="5" y1="12" x2="19" y2="12"></line></svg></button>'
						...
						+ '<button type="button" class="btn btn-primary btn-sm" onclick="changeAddNum(' + cart.productId + ',' + cart.quantity + ')" id="add" ><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-plus"><line x1="12" y1="5" x2="12" y2="19"></line><line x1="5" y1="12" x2="19" y2="12"></line></svg></button></td>';
...
function changeAddNum(productId, quantity) {
	quantity++;
