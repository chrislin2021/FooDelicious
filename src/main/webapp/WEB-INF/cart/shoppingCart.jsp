...
<body>
					...
					<li class="nav-item">
						<div class="dropdown">
							...
							<ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
								...
								<li><a class="dropdown-item"
									href="${contextRoot}/RegisterPage">暫時放訂單 || 還沒寫頁面</a></li>
			...
			<div class="container-fluid">
				...
				<form class="w-50 me-3">
					<input type="search" class="form-control"
						placeholder="法國製星鑽系列28CM不沾鍋鍋，沒有打折！！！" aria-label="Search">
				</form>
			</div>
		</nav>
	</div>
		...
		<tbody>
			<c:forEach var="carts" items="${carts}">
				<tr>
					...
					<td><input type="number" value="${carts.quantity}" min=1
						max=${carts.product.productStock }></td>
					<td>${carts.product.productPrice*carts.quantity}</td>
					<td><a onclick="return confirm('確定刪除嗎?')"
						href="/shoppingCart/${carts.cartId}" class="link-dark"><svg
	...
	<table class="goToPay">
		...
		<tbody>
			...
			<tr>
				<td colspan="2">總金額：900000000000000000&nbsp;
