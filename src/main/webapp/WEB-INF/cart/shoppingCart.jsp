...
<body>
		...
		<tbody>
			<c:forEach var="carts" items="${carts}">
				<tr>
					...
					<td><button onclick="deleteItem(${carts.product.productId})" class="link-dark">
	...
	<table class="goToPay">
		...
		<tbody>
			<tr>
				<td colspan="2">折扣金幣：<input type="number" value=0 min=1 max=10>個
				</td>
			</tr>
			<tr>
				<td colspan="2">運費：<del style="color: red;">100 元</del></td>
			</tr>
			<tr>
				<td colspan="2">總金額：${priceTotal}&nbsp;
					<button type="button" class="btn btn-warning">去買她媽的單</button>
				</td>
			</tr>
		</tbody>
	</table>
	...
	<div class="container">
		<footer class="d-flex flex-wrap justify-content-between align-items-center py-3 my-4 border-top">
			<div class="col-md-4 d-flex align-items-center">
				<a href="/" class="mb-3 me-2 mb-md-0 text-muted text-decoration-none lh-1"><svg class="bi" width="30" height="24"><use xlink:href="#bootstrap" /></svg></a> <span class="text-muted">&copy; 2021 Company, Inc</span>
			</div>
