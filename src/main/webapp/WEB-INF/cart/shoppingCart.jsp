...
<body>
		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav me-auto mb-2 mb-lg-0">
					...
					<li class="nav-item">
						<div class="dropdown">
							<button class="nav-link dropdown-toggle" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">會員相關<span class="caret"></span>
							</button>
		...
		<tbody>
			<c:forEach var="carts" items="${carts}">
				<tr>
					...
					<td><a onclick="return confirm('確定刪除嗎?')" href="/shoppingCart/${carts.cartId}" class="link-dark"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" 	stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-trash"><polyline points="3 6 5 6 21 6"></polyline><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"></path></svg></a></td>
				</tr>
			</c:forEach>
		</tbody>
	</table>
	...
	<table class="goToPay">
		...
		<tbody>
			<tr>
				<td colspan="2">折扣金幣：<input type="number" value=0 min=1 max=10>個</td>
			</tr>
			<tr>
				<td colspan="2">運費：<del style="color: red;">100 元</del></td>
			</tr>
			<tr>
				<td colspan="2">總金額：900000000000000000&nbsp;<button type="button" class="btn btn-warning">去買她媽的單</button></td>
			</tr>
		</tbody>
	</table>
