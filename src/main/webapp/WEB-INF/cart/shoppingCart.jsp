...
<body>
	...
	<svg xmlns="http://www.w3.org/2000/svg" style="display: none;"><symbol id="bootstrap" viewBox="0 0 118 94">	<title>WellCook</title>
		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav me-auto mb-2 mb-lg-0">
					...
					<li class="nav-item">
						<div class="dropdown">
							<a class="nav-link dropdown-toggle" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">會員相關<span class="caret"></span></a>
		...
		<nav class="navbar navbar-light bg-light">
			<div class="container-fluid">
				...
				<form class="w-50 me-3">
					<input type="search" class="form-control" 	placeholder="法國製星鑽系列28CM不沾鍋鍋，沒有打折！！！" aria-label="Search">
				</form>
			</div>
		</nav>
	</div>
		...
		<tbody id="cartList">
			<c:forEach var="carts" items="${carts}">
				<tr>
					...
					<td><button type="button" class="btn btn-secondary btn-sm" onclick=""><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-minus"><line x1="5" y1="12" x2="19" y2="12"></line></svg></button> 
							<input class="fw-bold" style="width: 2.5rem; text-align: center; border: none; background-color: transparent; " readonly="readonly" value="${carts.quantity}" disabled /> 
							<input class="" type="hidden" value="${carts.product.productStock}">
							<button type="button" class="btn btn-primary btn-sm" onclick=""><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-plus"><line x1="12" y1="5" x2="12" y2="19"></line><line x1="5" y1="12" x2="19" y2="12"></line></svg></button></td>
	...
	<table class="discount">
		...
		<tbody>
			<tr>
				<th scope="row">滿$1000，宅配到府，免運費！！<a href="#" class="tip">了解更多<span class="popbox"><table class="table" id="p">
								<thead>
									<tr>
										<th scope="col">低消</th>
										<th scope="col">運費</th>
	...
	<table class="goToPay">
		...
		<tbody>
			<tr>
				<td colspan="2">折扣金幣：<input type="number" value=0 min=0 max=10>個</td>
			</tr>
			<tr>
				<td colspan="2">運費：<c:if test="${priceTotal < 1000}"><span>運費: 100 元</span></c:if><c:if test="${priceTotal >= 1000}"><del style="color: red;">運費: 100 元</del>&nbsp;&nbsp;<span>運費: 0 元</span></c:if></td>
			</tr>
			<tr>
				<td colspan="2">總金額：<c:if test="${priceTotal < 1000}"><span>${priceTotal+100}&nbsp;</span></c:if><c:if test="${priceTotal >= 1000}"><span>${priceTotal}&nbsp;</span></c:if><button type="button" class="btn btn-warning">去買單</button></td>
			</tr>
		</tbody>
	</table>
	...
	<div class="container">
		<footer class="d-flex flex-wrap justify-content-between align-items-center py-3 my-4 border-top">
			<div class="col-md-4 d-flex align-items-center">
				<a href="/" class="mb-3 me-2 mb-md-0 text-muted text-decoration-none lh-1"><svg class="bi" width="30" height="24"></svg></a> 
