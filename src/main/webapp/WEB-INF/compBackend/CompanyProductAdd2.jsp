...
<div class="container mt-3">
	...
	<form action="/backend/product" enctype="multipart/form-data"
		method="post">
		商品分類:&emsp; <select class="form-select form-select-sm"
			aria-label=".form-select-sm example" name="productCategories"
		...
		<div class="row mb-2">
			<label for="productCategoriesName" class="col-sm-2 col-form-label">分類名稱
				:</label>
			<div class="col-sm-3">
				<input type="text" class="form-control" name="productCategoriesName"
					placeholder="分類名稱" />
			</div>
		</div>
		<div class="row mb-2">
			<label for="productName" class="col-sm-2 col-form-label">商品名稱
				:</label>
			<div class="col-sm-3">
		...
		<div class="row mb-2">
			...
			<div class="col-sm-3">
				<input type="text" class="form-control" name="productCompanyId"
					placeholder="公司編號" />
			</div>
		</div>
		<div class="row mb-2">
			<label for="productPrice" class="col-sm-2 col-form-label">商品價格
				:</label>
			<div class="col-sm-3">
		...
		<div class="row mb-2">
			<label for="productInsertDate" class="col-sm-2 col-form-label">商品日期：</label>
			<div class="col-sm-3">
				<input type="datetime-local" class="form-control"
					name="productInsertDate" placeholder="日期" />
			</div>
		</div>

		商品狀態:&emsp; <select class="form-select form-select-sm" aria-label=".form-select-sm example" name="productCategories" style="width: 13%; display:inline-block">
