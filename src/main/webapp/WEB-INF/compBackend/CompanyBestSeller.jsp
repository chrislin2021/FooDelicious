...
<h1 class="tableName">
    暢銷商品
    <span class="smallFont">Top selling products</span>
</h1>
<div class="foodArea">
    <h1 class="tableName"><i class="fas fa-hamburger"></i>食材類</h1>
...
<div class="toolArea">
    <h1 class="tableName"><i class="fas fa-hamburger"></i>餐廚類</h1>
    <div class="col-sm-5 report1">
