        ...
        <%@ taglib uri="http://tiles.apache.org/tags-tiles" prefix="tiles"%>
            ...
            <body>
                <header class="py-3 mb-3 border-bottom">
                    ...
                    <nav class="container-fluid navbar navbar-expand-lg navbar-light bg-lightd-grid gap-3 align-items-center" style="grid-template-columns: 1fr 2fr;">
                        ...
                        <div class="d-flex align-items-center">
                            <div class="flex-shrink-0 dropstart">
                                <a href="/loginSuccess">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-person" viewBox="0 0 16 16" class="rounded-circle"><path
