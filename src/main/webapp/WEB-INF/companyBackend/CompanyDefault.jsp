...
<head>
    ...
    <link rel="stylesheet" href="../../css/companyMain.css">
...
<div class="col-fixed topBrand ">
    <b class="align-middle brand"><a style="color:white; text-decoration:none" href="/companyMain">廠商後台管理系統</b>
</div>
...
<div class="row">
    <div class="navbar col-md-12 rightBrand justify-content-end">
        <ul class="nav nav-pills ">
            <li class="nav-item">
                <a class="nav-link text-white" href="/companyMain">首頁</a>
            </li>
        </ul>
    </div>
</div>
...
<div class="col-fixed leftBar">
    ...
    <ul class="list-group list-group-flush functionBar">
        ...
        <li id="ProductList" class="list-group-item funName">
            <a href="/companyProduct" style="text-decoration: none">
        ...
        <li id="OrderList" class="list-group-item">
            <a href="/companyOrder" style="text-decoration: none">
        ...
        <li id="BanList" class="list-group-item funName">
            <a href="#" style="text-decoration: none">
                <i class="text-secondary fas fa-ban"></i> <span>問題回報</span>
            </a>
        </li>
    </ul>
</div>
